...
void matrix::put_line(int value)
{
	this->line = value;
}
void matrix::put_column(int value)
{
	this->column = value;
}
...
int matrix:: index_input(int line, int column)
{
...
vector<int> matrix:: column_input(int num_column)
{
	vector<int> vector;
...
vector<int> matrix:: line_input(int num_line)
{
	vector<int> vector;
...
int matrix:: scalar(vector<int> vector1, vector<int> vector2)
{
	int result = 0;
...
int matrix:: update_by_index(int line, int column, int value)
{
	this->map[make_pair(line, column)] = this->map_insert_by_index(line,column) + value;
	return 0;
}

matrix matrix:: create_vector()
{
